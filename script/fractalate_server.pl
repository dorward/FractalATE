...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{FRACTALATE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{FRACTALATE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
fractalate_server.pl - Catalyst Testserver

=head1 SYNOPSIS

fractalate_server.pl [options]
